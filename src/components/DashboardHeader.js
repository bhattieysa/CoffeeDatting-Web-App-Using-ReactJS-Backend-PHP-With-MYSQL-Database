                    ...
                    <div className=" justify-between items-center w-full lg:flex lg:w-auto lg:order-1 " id="mobile-menu-2">
                        <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                            ...
                            <li>
                                ...
                                }} className="hover:cursor-pointer block py-2 pr-4 pl-3 text-white lg:dark:hover:text-main rounded bg-primary-700 lg:bg-transparent lg:text-primary-700 lg:p-0 dark:text-white" aria-current="page">Chat</div>
                            </li>
                            <li>
